    ...
    if (error) {
        return (
            <div className="p-10 text-center bg-[#8A9294]/10 min-h-screen flex items-center justify-center">
                <div className="inline-block p-8 bg-white rounded-[2rem] border-b-8 border-[#F85B1A] shadow-2xl">
                    <h2 className="text-[#072083] font-black uppercase italic text-2xl mb-4">¡ERROR EN EL RADAR!</h2>
                    <Link to="/dragonball" className="text-[#F85B1A] font-bold uppercase tracking-widest text-xs hover:underline">Volver al inicio</Link>
                </div>
            </div>
        );
    }
